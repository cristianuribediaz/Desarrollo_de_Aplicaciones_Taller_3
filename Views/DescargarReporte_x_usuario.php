...
//Informacion del PDF
$pdf->SetTitle('Reporte por usuarios registrados');
...
$pdf->Cell(100,6,'REPORTE DE REGISTRO DE USUARIOS',0,0,'C');
...
$pdf->Cell(34,6,'Direccion',1,0,'C',1); 
...
$sqlUsuarios = ("SELECT * FROM usuario WHERE (fecha_ingreso>='$fechaInit' and fecha_ingreso<='$fechaFin') ORDER BY fecha_ingreso ASC");
$query = mysqli_query($con, $sqlUsuarios);

while ($dataRow = mysqli_fetch_array($query)) {
        $pdf->Cell(20,6,($dataRow['codigo']),1,0,'C');
        $pdf->Cell(55,6,$dataRow['nombre'],1,0,'C');
        $pdf->Cell(26,6,($dataRow['telefono']),1,0,'C');
        $pdf->Cell(34,6,$dataRow['direccion'],1,0,'C');
