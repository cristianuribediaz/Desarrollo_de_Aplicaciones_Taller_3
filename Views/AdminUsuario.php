...
<div class="table-responsive">
  <br>  <br>  
    <div class="row">
      <h6>Reporte de los usuarios ingresados al sistema en fechas determinadas</h6>
        <div class="col-md-12 text-center">
          <form action="../Views/DescargarReporte_x_usuario.php" method="post" accept-charset="utf-8">
            <div class="row">
              <div class="col">
