...
//Informacion del PDF
$pdf->SetTitle('Reporte editoriales registradas');
...
$pdf->Cell(100,6,'REPORTE DE REGISTRO DE EDITORIALES',0,0,'C');
$pdf->Ln(6); //Salto de Linea
$pdf->Cell(180,6,'INGRESADAS AL SISTEMA DE BIBLIOTECA',0,0,'C');
...
$sqlAutores = ("SELECT * FROM editorial WHERE (fecha_ingreso>='$fechaInit' and fecha_ingreso<='$fechaFin') ORDER BY fecha_ingreso ASC");
