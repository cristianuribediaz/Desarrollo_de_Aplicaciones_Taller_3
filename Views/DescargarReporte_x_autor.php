...
//Informacion del PDF
$pdf->SetTitle('Reporte autores registrados');
...
$pdf->Cell(100,6,'REPORTE DE REGISTRO DE AUTORES',0,0,'C');
...
$pdf->Cell(55,6,'Fecha de Ingreso',1,1,'C',1);
...
$sqlAutores = ("SELECT * FROM autor WHERE (fecha_ingreso>='$fechaInit' and fecha_ingreso<='$fechaFin') ORDER BY fecha_ingreso ASC");

$query = mysqli_query($con, $sqlAutores);

while ($dataRow = mysqli_fetch_array($query)) {
        $pdf->Cell(25,6,($dataRow['codigo']),1,0,'C');
        $pdf->Cell(85,6,$dataRow['nombre'],1,0,'C');
        $pdf->Cell(55,6,(date('m-d-Y', strtotime($dataRow['fecha_ingreso']))),1,1,'C');
    }
